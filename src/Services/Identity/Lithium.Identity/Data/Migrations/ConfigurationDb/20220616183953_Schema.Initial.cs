    ...
    public partial class SchemaInitial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, new DateTime(2022, 6, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Masterdata API Service", true, null, "MasterdataAPI", false, true, null });

            migrationBuilder.InsertData(
                table: "ApiScopes",
                columns: new[] { "Id", "Description", "DisplayName", "Emphasize", "Enabled", "Name", "Required", "ShowInDiscoveryDocument" },
                values: new object[] { 1, null, "Masterdata API Scope", false, true, "MasterdataAPI", false, true });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2592000, 3600, 0, true, false, false, true, null, false, false, 300, true, null, "client_", "lithium-ui", "Lithium Frontend UI OpenId Client", "https://localhost:6004", null, new DateTime(2022, 6, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Lithium Frontend UI OpenId Client for Development", 300, true, true, true, null, 300, true, null, null, false, null, "oidc", 1, 1, true, false, true, false, 1296000, false, null, null, null },
                    { 2, 2592000, 3600, 0, true, false, false, true, null, false, false, 300, true, null, "client_", "lithium-masterdata-api", "Lithium API Swagger UI", null, null, new DateTime(2022, 6, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Lithium API Swagger UI for Development", 300, true, true, true, null, 300, true, null, null, false, null, "oidc", 1, 1, true, false, true, false, 1296000, false, null, null, null },
                    { 3, 2592000, 3600, 0, true, false, false, true, null, false, false, 300, true, null, "client_", "lithium-ui--prod", "Lithium Frontend UI OpenId Client", "https://lithium.web.azurewebsites.net", null, new DateTime(2022, 6, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Lithium Frontend UI OpenId Client for Production", 300, true, true, true, null, 300, true, null, null, false, null, "oidc", 1, 1, true, false, true, false, 1296000, false, null, null, null },
                    { 4, 2592000, 3600, 0, true, false, false, true, null, false, false, 300, true, null, "client_", "lithium-masterdata-api--prod", "Lithium API Swagger UI", null, null, new DateTime(2022, 6, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Lithium API Swagger UI for Production", 300, true, true, true, null, 300, true, null, null, false, null, "oidc", 1, 1, true, false, true, false, 1296000, false, null, null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 6, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Your user profile information (first name, last name, etc.)", "User profile", true, true, "profile", false, false, true, null },
                    { 2, new DateTime(2022, 6, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Your user identifier", false, true, "openid", false, true, true, null }
                });

            migrationBuilder.InsertData(
                table: "ApiResourceScopes",
                columns: new[] { "Id", "ApiResourceId", "Scope" },
                values: new object[] { 1, 1, "MasterdataAPI" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 3, "https://lithium.web.azurewebsites.net" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, 3, "https://lithium.web.azurewebsites.net/" },
                    { 4, 4, "https://lithium.api.azurewebsites.net/swagger/" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, 3, "https://lithium.web.azurewebsites.net/" },
                    { 4, 4, "https://lithium.api.azurewebsites.net/swagger/oauth2-redirect.html" }
                });
